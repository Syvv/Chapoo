namespace UI
{
    partial class ItemOptiesControl
    {
        ...
        {
            this.bntEen = new StyleGuide.BaseButton();
            this.btnTwee = new StyleGuide.BaseButton();
            this.btnDrie = new StyleGuide.BaseButton();
            this.btnVier = new StyleGuide.BaseButton();
            this.vtnVijf = new StyleGuide.BaseButton();
            this.vtnZes = new StyleGuide.BaseButton();
            this.vtnZeven = new StyleGuide.BaseButton();
            ...
            this.Controls.Add(this.vtnZeven);
            this.Controls.Add(this.vtnZes);
            this.Controls.Add(this.vtnVijf);
