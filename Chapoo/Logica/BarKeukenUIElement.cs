...
namespace Logica
{
    public class BarKeukenUIElement
    {
        ...
        public BarKeukenUIElement(Bestellingsitem b, Refresh del, int x, int y)
        {
            Item = b;
            //Controls.Add();
            GroupBox gr = new GroupBox { Top = y, Left = x, Height = 50, Width = 1610, BackColor = System.Drawing.Color.LightBlue };
            Controls.Add(new Label { Text = Item.Name, Top = y+15, Left = x + 145, Width = 650, Font = new System.Drawing.Font("Arial",16), Height = 30, BackColor = System.Drawing.Color.LightBlue });
            Controls.Add(new Label { Text = Item.Amount.ToString() + "x", Top = y+15, Left = x + 100, Width = 45, Font = new System.Drawing.Font("Arial", 16), Height = 30, BackColor = System.Drawing.Color.LightBlue });
            ...
            {
                Controls.Add(new Label { Text = "("+ Item.Comment.Substring(0, 22) + "...)", Top = y+15, Left = x + 795, Width = 300, Font = new System.Drawing.Font("Arial", 16), Height = 30, BackColor = System.Drawing.Color.LightBlue });
            }
            else
            {
                Controls.Add(new Label { Text = "("+Item.Comment+")", Top = y+15, Left = x + 795, Width = 300, Font = new System.Drawing.Font("Arial", 16), Height = 30, BackColor = System.Drawing.Color.LightBlue });
            }
            Controls.Add(new Button { Text = "1 item gereedstellen", Top = y+7, Left = x + 1095, Width = 200, Font = new System.Drawing.Font("Arial", 12), Height = 40, TextAlign=System.Drawing.ContentAlignment.MiddleCenter });
            Controls.Add(new Button { Text = "Hele rij gereedstellen", Top = y+7, Left = x + 1295, Width = 200, Font = new System.Drawing.Font("Arial", 12), Height = 40, TextAlign = System.Drawing.ContentAlignment.MiddleCenter });
            Controls.Add(new Label { Text = Item.Timestamp.ToLongTimeString(), Top = y+15, Left = x + 1495, Width = 100, Font = new System.Drawing.Font("Arial", 16), Height = 30, BackColor = System.Drawing.Color.LightBlue });
